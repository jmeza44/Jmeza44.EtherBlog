...
try
{
    ...
    Log.Information("Migrating Identity Configuration entities in the Tenants database...");
    await DatabasesMigrator.MigrateIdentityConfigurationAsync(app);
    Log.Information("Done Migrating Identity Configuration entities in the Tenants database. Exiting.");
    ...
    Log.Information("Migrating Identity Operational entities in the Tenants database...");
    await DatabasesMigrator.MigrateIdentityOperationalAsync(app);
    Log.Information("Done Migrating Identity Operational entities in the Tenants database. Exiting.");

    Log.Information("Migrating Tenants Users databases...");
    await DatabasesMigrator.MigrateUsersDatabaseAsync(app);
    Log.Information("Done Migrating Tenants Users databases. Exiting.");

    Log.Information("Seeding Tenants Users databases...");
    await SeedData.SeedUsersAsync(app);
    Log.Information("Done seeding Tenants Users databases. Exiting.");
